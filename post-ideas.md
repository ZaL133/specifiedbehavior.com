...
Shoot for 2 per week. Rank these (1 = highest priority) and I'll write them in order.
...
- [ ] **The Case for AI Optimism** — a measured counterpoint to doom-and-gloom coverage
- [ ] **What "AI Alignment" Actually Means, and Why It's Hard** — strip away the sci-fi and explain the real technical and philosophical challenge
- [ ] **The Jobs AI Is Actually Taking (And The Ones It Isn't)** — grounded look at labor market data vs. speculation
...
- Update `sitemap.xml` with the new URL and today's date
